...
def reporteMovEntradaMP(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'MateriaPrima/Entrada.html', {
        ...
        Contenedor = ''
    print("Hola mundo")
    return render(request, 'MateriaPrima/Entrada.html', {'FContenedores': FContenedores, 'reportes': reportes, 'FechaDeHoy': FechaDeHoy, 
...
def reporteMovSalidaMP(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'MateriaPrima/Salida.html', {
    ...
    if request.method == 'POST':
        if 'reportes' in request.POST:
            ...
            if Cliente == 'todos':
                ...
                Nombre = 'Se trajeron todos los clientes'
                Cliente = 'todos'
                return render(request, 'Animales/Movimiento.html', {'reportes': reportes, 'FMovimientos':FMovimientos,
    ...
    if request.method == 'POST':
        if 'reportes' in request.POST:
            ...
            if Cliente == 'todos':
                ...
                Nombre = 'Se trajeron todos los clientes'
                Cliente = 'todos'
                return render(request, 'Animales/Cliente.html', {'reportes': reportes,
    ...
    if request.method == 'POST':
        if 'reportes' in request.POST:
            ...
            if Cliente == 'todos':
                ...
                print(Nombre)
                Cliente = 'todos'
                return render(request, 'Servidos/Movimiento.html', {'reportes': reportes,
                                                                                      'FClientes': FClientes, 'Nombre': Nombre, 'Cliente': Cliente, 'Fecha': Fecha, 'Fecha2': Fecha2})
            else:
    ...
    if request.method == 'POST':
        if 'reportes' in request.POST:
            ...
            if Cliente == 'todos':
                ...
                return render(request, 'Servidos/Liquidacion.html', {'reportes': reportes, 'reportes2': reportes2,
                'FClientes': FClientes, 'Nombre': Nombre, 'Cliente': Cliente, 'Fecha': Fecha, 'Fecha2': Fecha2,
                'DataToRep':DataToRep})
            else:
                consulta_sql = """SELECT Aplicacion_tblcorrales.Descripcion, Aplicacion_tblproductos.Descripcion, Aplicacion_tblunidades.Abreviacion, 
        ...
        Nombre = 'Buscar cliente'
        Cliente = ''
        return render(request, 'Servidos/Liquidacion.html', {'reportes': reportes,
        'FechaDeHoy': FechaDeHoy, 'FClientes': FClientes, 'Nombre': Nombre, 'Cliente': Cliente})
