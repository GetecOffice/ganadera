...
def TablaEstatus(request):
    ...
    return render(request, 'Estatus/index.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,
    'TEstatus': TEstatus})
...
def TablaTipoMaterial(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'TipoMaterial/index.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,
...
def TablaTipoMovimiento(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'TipoMovimiento/index.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,
...
def TablaTipoPresentacion(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'TipoPresentacion/index.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,
...
def TablaUnidadMedida(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'UnidadMedida/index.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,
