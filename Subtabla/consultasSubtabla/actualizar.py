...
def actualizarTipoMaterial(request):
   ...
   # tecnicos
    ...
    if nombre_existente:
        ...
        IDNumber = int(id)
        return redirect('subtabla:E_Tipo_Material', IDNumber)
    else:
...
def actualizarTipoMovmimiento(request):
   ...
   # tecnicos
    ...
    if nombre_existente:
        ...
        IDNumber = int(id)
        return redirect('subtabla:E_Tipo_Movimiento', IDNumber)
    else:
...
def actualizarTipoPresentacion(request):
   ...
   # tecnicos
    ...
    if nombre_existente:
        ...
        IDNumber = int(id)
        return redirect('subtabla:E_Tipo_Presentacion', IDNumber)
    else:
