...
def guardarTipoMaterial(request):
    ...
    if existente:
        ...
        columnas = {'clave': clave, 'errorCol':errorCol}
        return render(request, "TipoMaterial/form.html", columnas)
    else:
    ...
    if request.method == 'POST':
        if 'salir' in request.POST:
            return redirect('subtabla:T_Tipo_Material')
        elif 'agregar' in request.POST:
            return redirect('subtabla:F_Tipo_Material')
    else:
        return redirect('subtabla:T_Tipo_Material')
...
def guardarTipoMovimiento(request):
    ...
    if existente:
        ...
        columnas = {'clave': clave, 'errorCol':errorCol}
        return render(request, "TipoMovimiento/form.html", columnas)
    else:
    ...
    if request.method == 'POST':
        if 'salir' in request.POST:
            return redirect('subtabla:T_Tipo_Movimiento')
        elif 'agregar' in request.POST:
            return redirect('subtabla:F_Tipo_Movimiento')
    else:
        return redirect('subtabla:T_Tipo_Movimiento')
...
def guardarTipoPresentacion(request):
    ...
    if existente:
        ...
        return render(request, "TipoPresentacion/form.html", columnas)
    else:
    ...
    if request.method == 'POST':
        if 'salir' in request.POST:
            return redirect('subtabla:T_Tipo_Presentacion')
        elif 'agregar' in request.POST:
            return redirect('subtabla:F_Tipo_Presentacion')
    else:
        return redirect('subtabla:T_Tipo_Presentacion')
