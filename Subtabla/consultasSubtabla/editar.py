...
def editarEstatus(request, ID):
    ...
    return render(request, "Estatus/edit.html",{'grupos': grupos,'TEEstatus': TEEstatus})

def editarTipoMaterial(request, ID):
    grupos = grupo_user(request)
    TETipoMaterial = tblTipoMaterial.objects.get(ID=ID)
    return render(request, "TipoMaterial/edit.html",{'grupos': grupos,'TETipoMaterial': TETipoMaterial})

def editarTipoMovimiento(request, ID):
    grupos = grupo_user(request)
    TETipoMov = tblTipoMov.objects.get(ID=ID)
    return render(request, "TipoMovimiento/edit.html",{'grupos': grupos,'TETipoMov': TETipoMov})
...
def editarTipoPresentacion(request, ID):
    ...
    return render(request, "TipoPresentacion/edit.html",{'grupos': grupos,'TETipoPresentacion': TETipoPresentacion,
...
def editarUnidadMedida(request, ID):
    ...
    return render(request, "UnidadMedida/edit.html",{'grupos': grupos,'TEUnidadMedida': TEUnidadMedida})
