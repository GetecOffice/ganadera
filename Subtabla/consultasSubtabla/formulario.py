...
def formularioEstatus(request):
    ...
    return render(request, 'Estatus/form.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,
...
def formularioTipoMaterial(request):
    ...
    if ultimo_id:
        ...
        ultimo_folio = 1
    ServiciosWeb = servicioActivo()
    return render(request, 'TipoMaterial/form.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,
    'ultimo_folio': ultimo_folio})
...
def formularioTipoMovimiento(request):
    ...
    if ultimo_id:
        ...
        ultimo_folio = 1
    ServiciosWeb = servicioActivo()
    return render(request, 'TipoMovimiento/form.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,
    'ultimo_folio': ultimo_folio})
...
def formularioTipoPresentacion(request):
    ...
    return render(request, 'TipoPresentacion/form.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,
...
def formularioUnidadMedida(request):
    ...
    if ultimo_id:
        ...
        ultimo_folio = 1
    ServiciosWeb = servicioActivo()
    return render(request, 'UnidadMedida/form.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,
    'ultimo_folio': ultimo_folio})
