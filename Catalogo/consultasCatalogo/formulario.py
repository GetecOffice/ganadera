...
def FormualrioClientes(request):
    ...
    return render(request, 'Cliente/form.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,
...
def FormualrioProveedores(request):
    ...
    if ultimo_id:
        ...
        ultimo_folio = 1
    ServiciosWeb = servicioActivo()
    return render(request, 'Proveedor/form.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,
    'ultimo_folio': ultimo_folio})
...
def FormualrioOperadores(request):
    ...
    return render(request, 'Operador/form.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,
...
def FormualrioMateriasPrimas(request):
    ...
    return render(request, 'MateriaPrima/form.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,
...
def FormualrioProductos(request):
    ...
    FEstatus=tblEstatus.objects.filter(ID__lte=2).order_by('Descripcion')
    FUnidadMedida=tblUnidades.objects.all().order_by('Descripcion')
    return render(request, 'Producto/form.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,
    'ultimo_folio': ultimo_folio, 'FEstatus': FEstatus, 'FUnidadMedida': FUnidadMedida})
...
def FormualrioCorrales(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'Corral/form.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,
...
def FormualrioTipoAnimaless(request):
    ...
    ServiciosWeb = servicioActivo()
    FEstatus = tblEstatus.objects.filter(ID__lte=2).order_by('Descripcion')
    return render(request, 'TipoAnimal/form.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,
...
def FormualrioContnendoresMateriasPrimas(request):
    ...
    return render(request, 'ContenedorMP/form.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,
...
def FormualrioContenedoresProductos(request):
    ...
    return render(request, 'ContenedorProducto/form.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb, 
...
def FormualrioTolva(request):
    ...
    return render(request, 'Tolva/form.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,
    'ultimo_folio': ultimo_folio,'FEstatus': FEstatus, 'FUnidadMedida': FUnidadMedida})