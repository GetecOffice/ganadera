...
from Usuarios.views import grupo_user
...
def editarCliente(request, ID):
    ...
    return render(request, "Cliente/edit.html",{'grupos': grupos,'TECliente': TECliente})
...
def editarProveedor(request, ID):
    ...
    return render(request, "Proveedor/edit.html",{'grupos': grupos,'TEProveedor': TEProveedor})
...
def editarOperador(request, ID):
    ...
    return render(request, "Operador/edit.html",{'grupos': grupos,'TEOperador': TEOperador,'FiltradoEstatus': FiltradoEstatus,'FEEstatus': FEEstatus})
...
def editarMateriaPrima(request, ID):
    ...
    return render(request, "MateriaPrima/edit.html",{'grupos': grupos,'TEMateriaPrima': TEMateriaPrima,'FiltradoEstatus': FiltradoEstatus,'FiltradoUnidad': FiltradoUnidad,'FEEstatus': FEEstatus,'FEUnidad': FEUnidad})
...
def editarProducto(request, ID):
    ...
    FEEstatus = tblEstatus.objects.filter(ID__lte=2).order_by('Descripcion')
    FEUnidad = tblUnidades.objects.all().order_by('Descripcion')
    return render(request, "Producto/edit.html",{'grupos': grupos,'TEProductos': TEProductos,'FiltradoEstatus': FiltradoEstatus,'FiltradoUnidad': FiltradoUnidad,'FEEstatus': FEEstatus,'FEUnidad': FEUnidad})
...
def editarProductoReceta(request, ID):
    ...
    print(total)
    return render(request, "Producto/editReceta.html",{'grupos': grupos, 'total':total, 
...
def editarCorral(request, ID):
    ...
    return render(request, "Corral/edit.html",{'grupos': grupos,'fecha':fecha, 'TECorrales': TECorrales,'FiltradoEstatus': FiltradoEstatus,'FiltradoCliente': FiltradoCliente,'FEEstatus': FEEstatus,'FECliente': FECliente})
...
def editarTipoAnimal(request, ID):
    ...
    FiltradoEstatus= tblEstatus.objects.get(ID=Estatus)
    FEEstatus = tblEstatus.objects.filter(ID__lte=2).order_by('Descripcion')
    return render(request, "TipoAnimal/edit.html",{'grupos': grupos,'TEAnimalTipo': TEAnimalTipo,'FiltradoEstatus': FiltradoEstatus,'FEEstatus': FEEstatus})
...
def editarContenendorMP(request, ID):
    ...
    FEEstatus = tblEstatus.objects.filter(ID__lte=2).order_by('Descripcion')
    FECliente = tblClientes.objects.exclude(ID=0).all().order_by('Nombre')
    return render(request, "ContenedorMP/edit.html",{'grupos': grupos,'TEContenedorMP': TEContenedorMP,'FiltradoEstatus': FiltradoEstatus,'FiltradoCliente': FiltradoCliente,'FEEstatus': FEEstatus,'FECliente': FECliente})
...
def editarContnenedorProducto(request, ID):
    ...
    return render(request, "ContenedorProducto/edit.html",{'grupos': grupos,'TEContenedorProductos': TEContenedorProductos,'FiltradoEstatus': FiltradoEstatus,'FiltradoProveedores': FiltradoProveedores,'FEEstatus': FEEstatus,'FEProveedores': FEProveedores})
...
def editarTolva(request, ID):
    ...
    return render(request, "Tolva/edit.html",{'grupos': grupos, 'FEUnidades':FEUnidades, 
