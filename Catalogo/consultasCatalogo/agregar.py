...
def guardarCliente(request):
    ...
    if nombre_Existe:
        ...
        return render(request, "Cliente/form.html", columnas)
    else:
    ...
    if request.method == 'POST':
        if 'salir' in request.POST:
            return redirect('catalogo:T_Cliente')
            ...
            if 'guardar-datos' in request.POST: 
                ...
                return redirect('catalogo:F_Cliente')
    else:
        return redirect('catalogo:T_Cliente')
...
def guardarProveedor(request):
    ...
    if existente:
        ...
        return render(request, "Proveedor/form.html", columnas)
    else:
    ...
    if request.method == 'POST':
        if 'salir' in request.POST:
            return redirect('catalogo:T_Proveedor')
        elif 'agregar' in request.POST:
            if 'guardar-datos' in request.POST: 
                guardar = True
                columnas = {'clave':ultimo_folio, 'contacto':contacto, 'direccion':direccion,
                ...
                return redirect('catalogo:F_Proveedor')
    else:
        return redirect('catalogo:T_Proveedor')
...
def guardarTipoAnimales(request):
    ...
    if existente:
        ...
        return render(request, "Tipo Animal/form.html", columnas)
    else:
    ...
    if request.method == 'POST':
        if 'salir' in request.POST:
            return redirect('catalogo:T_TipoAnimal')
        elif 'agregar' in request.POST:
            return redirect('catalogo:F_TipoAnimal')
    else:
        return redirect('catalogo:T_TipoAnimal')
...
def guardarContenedoresMateriasPrimas(request):
    ...
    if request.method == 'POST':
        if 'salir' in request.POST:
            return redirect('catalogo:T_ContenedorMP')
        elif 'agregar' in request.POST:
            return redirect('catalogo:F_ContenedorMP')
    else:
        return redirect('catalogo:T_ContenedorMP')
...
def guardarContenedoresProductos(request):
    ...
    if request.method == 'POST':
        if 'salir' in request.POST:
            return redirect('catalogo:T_ContenedorProducto')
        elif 'agregar' in request.POST:
            return redirect('catalogo:F_ContenedorProducto')
    else:
        return redirect('catalogo:T_ContenedorProducto')
