...
def TablaProveedores(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'Proveedor/index.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,'TProveedores': TProveedores }) 
...
def TablaOperadores(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'Operador/index.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,'TOperadores': TOperadores})
...
def TablaMateriasPrimas(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'MateriaPrima/index.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,'TMateriasPrimas': TMateriasPrimas})
...
def AgregarRecetas(request, ID):
    ...
    print(total)
    ServiciosWeb = servicioActivo()
    return render(request, "Producto/agregar.html",{'grupos': grupos,'AgRecetas': AgRecetas, 'ServiciosWeb': ServiciosWeb,
...
def detalleRecetas(request, ID):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'Producto/verDetalle.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,'Recetas': Recetas})
...
def TablaProductos(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'Producto/index.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,'TProductos': TProductos})
...
def TablaCorrales(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'Corral/index.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,
    'TCorrales': TCorrales})
...
def TablaTipoAnimales(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'TipoAnimal/index.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,'TTipoAnimales': TTipoAnimales})
...
def TablaContenedoresMateriasPrimas(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'ContenedorMP/index.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,'TContenedoresMP': TContenedoresMP})
...
def TablaContenedoresProductos(request):
    ...
    TContenedoresProductos = tblContenedoresProductos.objects.values('ID', 'Clave', 'Proveedor', 'IDEstatus_id__Descripcion',
                                                                 'Capacidad','IDCliente_id__Nombre')
    ServiciosWeb = servicioActivo()
    return render(request, 'ContenedorProducto/index.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,'TContenedoresProductos': TContenedoresProductos})
...
def TablaTolva(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'Tolva/index.html',{'grupos': grupos,
