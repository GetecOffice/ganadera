...
def guardarEntradaMateriaPrima(request):
    ...
    if request.method == 'POST':
        if 'salir' in request.POST:
            return redirect('proceso:T_Ent_Materia_Prima')
            ...
            return render(request, "EntradaMateriaPrima/form.html", context)
    else:
...
def guardarSalidasMateriaPrima(request):
    ...
    if request.method == 'POST':
        if 'salir' in request.POST:
            return redirect('proceso:T_Sal_Materia_Prima')
        elif 'agregar' in request.POST:
            ...
            return render(request, "SalidaMateriaPrima/form.html", context)
    else:
        return redirect('proceso:T_Sal_Materia_Prima')
...
def guardarEntradaBasculas(request):
    ...
    if request.method == 'POST':
        if 'salir' in request.POST:
            return redirect('proceso:T_Ent_Productos')
        elif 'agregar' in request.POST:
            ...
            return render(request, "EntradaProductos/form.html", context)
    else:
        return redirect('proceso:T_Ent_Productos')
...
def guardarSalidaBasculas(request):
    ...
    if request.method == 'POST':
        if 'salir' in request.POST:
            return redirect('proceso:T_Sal_Productos')
        elif 'agregar' in request.POST:
            ...
            return render(request, "SalidaProducto/form.html", context)
...
def guardarMovimientos(request):
    ...
    if request.method == 'POST':
        if 'salir' in request.POST:
            return redirect('proceso:T_MovAnimales')
        elif 'agregar' in request.POST:
            return render(request, "MovimientoAnimales/agregar.html", {'formatoClave':formatoClave, 'ServiciosWeb': ServiciosWeb, 
...
def guardarMovimientoAniamles(request):
    ...
    if request.method == 'POST':
        if 'salir' in request.POST:
            ...
            agregarDatosTecnicos(request, Tecnico_v, NombreTabla_v, IDFilaTabla_v, AreaRegistro_v, IDFila_v)
            messages.success(request, f'El movimiento de animales  ha sido registrado exitosamente')
            return redirect('proceso:F_MovAnimales')
            ...
            return render(request, "MovimientoAnimales/form.html", {'formatoClave':formatoClave,'Agrego_aniamles':Agrego_aniamles, 
    ...
    if request.method == 'POST':
        if peticion == '1' or peticion == 1:
            if 'salir' in request.POST:
                ...
                return render(request, 'SolicitudServido/form.html',{'FClientes':FClientes,
