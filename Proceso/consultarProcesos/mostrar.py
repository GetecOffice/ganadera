...
def obtener_clientes(request, id):
    print("Solicitud recibida con ID:", id)    
    try:
...
def TablaEntradaMateriasPrimas(request):
    ...
    return render(request, 'EntradaMateriaPrima/index.html',{'grupos': grupos,'TEntradaMateriasPrimas': TEntradaMateriasPrimas,
...
def TablaSalidaMateriasPrimas(request):
    ...
    return render(request, 'SalidaMateriaPrima/index.html',{'grupos': grupos,
...
def TablaEntradaProductos(request):
    ...
    ServiciosWeb = servicioActivo()
    FTransporteMP = tblOtrosDatosMovMP.objects.all()
    print(TEntradaProductos)
    return render(request, 'EntradaProductos/index.html',{'grupos': grupos,
...
def TablaSalidaProductos(request):
    ...
    ServiciosWeb = servicioActivo()
    FTransporte = tblOtrosDatosSalXBas.objects.all()
    return render(request, 'SalidaProducto/index.html',{'grupos': grupos,'TSalidaProductos': TSalidaProductos,
    'ServiciosWeb':ServiciosWeb, 'FTransporte':FTransporte})
...
def TablaOperadoresEntradaProductos(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, "EntradaProductos/verOperador.html",{'grupos': grupos,
...
def TablaOperadoresSalidaProductos(request):
    ...
    usuarioOperador= User.objects.get(id=usuario)
    ServiciosWeb = servicioActivo()
    return render(request, "SalidaProducto/verOperador.html",{'grupos': grupos,
    'usuarioOperador':usuarioOperador, 'ServiciosWeb': ServiciosWeb, 'tblOperador': tblOperador})
...
def TablaOperadoresEntradaMateriasPrimas(request):
    ...
    usuarioOperador= User.objects.get(id=usuario)
    ServiciosWeb = servicioActivo()
    return render(request, "EntradaMateriaPrima/verOperadorMP.html",{'grupos': grupos,
    'usuarioOperador':usuarioOperador, 'ServiciosWeb':ServiciosWeb, 'tblOperador': tblOperador})
...
def TablaOperadoresSalidasMateriasPrimas(request):
    ...
    usuarioOperador= User.objects.get(id=usuario)
    ServiciosWeb = servicioActivo()
    return render(request, "SalidaMateriaPrima/verOperador.html",{'grupos': grupos,
    'usuarioOperador':usuarioOperador, 'ServiciosWeb':ServiciosWeb, 'tblOperador': tblOperador})
...
def AgregarMovimientoAnimales(request, ID):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, "MovimientoAnimales/agregar.html",{'grupos': grupos,'AgMovimientos': AgMovimientos,
...
def detalleAnimales(request, ID):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'MovimientoAnimales/verDetalle.html',{'grupos': grupos,'ServiciosWeb': ServiciosWeb,'Detalle': Detalle})
...
def TablaMovimientoAnimales(request):
    ...
    if Movimiento is not None and Movimiento != '':
        ...
        'Folio', 'IDCliente_id__Nombre', 'IDMovimiento_id__Descripcion', 'Fecha', 'Peso', 'NoPartida'
         ...
         Movimiento  = "Entrada"
    ServiciosWeb = servicioActivo()
    return render(request, 'MovimientoAnimales/index.html',{'grupos': grupos, 'Movimiento':Movimiento,
...
def TablaDetallesAnimales(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'DetallesAnimales/index.html',{'grupos': grupos,
...
def TablaSolicitudServido(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'SolicitudServido/index.html',{'grupos': grupos, 'ServiciosWeb':ServiciosWeb,'TServidos': TServidos })
...
def TablaServidoCorral(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'ServidoListo/index.html',{'grupos': grupos, 'ServiciosWeb':ServiciosWeb,'TServidos': TServidos })
...
def TablaTolvaServidoCorral(request):
    ...
    return render(request, 'ServidosConsolidacion/tolva.html',{'grupos': grupos,
...
def TablaFiltroServido(request):
    ...
    if producto is not None and producto != '':
        ...
        return render(request, 'ServidoConsolidacion/index.html',{'grupos': grupos, 'producto_tolva':producto_tolva,
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'ServidoConsolidacion/index.html',{'grupos': grupos,
...
def TablaConsolidacionServido(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'ServidosConsolidacion/index.html', {'grupos': grupos,
...
def TablaServidoAnimales(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'ServidoManual/index.html',{'grupos': grupos, 'ServiciosWeb':ServiciosWeb,'TServidos': TServidos })
...
def TablaInventarioMateriaPrima(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'InventarioMateriaPrima/index.html',{'grupos': grupos, 'ServiciosWeb':ServiciosWeb, 'TInventarioMateriaPrima': TInventarioMateriaPrima,
...
def TablaInventarioProducto(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'InventarioProductos/index.html',{'grupos': grupos, 'ServiciosWeb':ServiciosWeb, 'TInventarioProducto': TInventarioProducto,
    'ServiciosWeb':ServiciosWeb})
...
def asignacionCorral(request):
    ...
    if asignar is not None and asignar != '':
        ...
        return render(request, 'AsignarCorrales/index.html',{'grupos': grupos,
    ...
    if liberar is not None and liberar != '':
        ...
        return render(request, 'AsignarCorrales/index.html',{'grupos': grupos, 'ServiciosWeb':ServiciosWeb, 'TClienteCorrales': TClienteCorrales, 'TCorralesLibres':TCorralesLibres, 'FClientes':FClientes, 'clientePost': clientePost})
...
def TablaHistorialAsignacionCorral(request):
    ...
    ServiciosWeb = servicioActivo()
    print("HOla")
    return render(request, 'AsignarCorrales/historial.html',{'grupos': grupos, 'ServiciosWeb':ServiciosWeb,
...
def TablaCargamentoTolva(request):
    ...
    print("Gola mundo")
    ServiciosWeb = servicioActivo()
    return render(request, 'TolvaProcesos/index.html',{'grupos': grupos, 'ServiciosWeb':ServiciosWeb,'TTolva': TTolva, 'TServido':TServido })