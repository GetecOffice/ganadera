...
def FormularioEntradaMateriasPrimas(request):
    ...
    return render(request, 'EntradaMateriaPrima/form.html',{'grupos': grupos, 'ServiciosWeb': ServiciosWeb, 
...
def FormularioOperadorEntradaMateriaPrima(request, ID):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, "EntradaMateriaPrima/agregar.html",{'grupos': grupos, 'ServiciosWeb': ServiciosWeb, 
...
def FormularioSalidaMateriasPrimas(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'SalidaMateriaPrima/form.html',{'grupos': grupos, 'ServiciosWeb': ServiciosWeb, 
...
def FormularioOperadorSalidaMateriaPrima(request, ID):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, "SalidaMateriaPrima/agregar.html",{'grupos': grupos, 'ServiciosWeb': ServiciosWeb, 
    'usuarioOperador':usuarioOperador, 'tblOperador': tblOperador})
...
def FormularioEntradaProductos(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'EntradaProductos/form.html',{'grupos': grupos, 'ServiciosWeb': ServiciosWeb, 
...
def FormularioOperadoresEntradaProductos(request, ID):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, "EntradaProductos/agregar.html",{'grupos': grupos, 'ServiciosWeb': ServiciosWeb, 
    'usuarioOperador':usuarioOperador, 'tblOperador': tblOperador})
...
def FormularioSalidaProductos(request):
    ...
    ServiciosWeb = servicioActivo()
    FechaDeHoy = timezone.localtime(timezone.now()).strftime('%Y-%m-%d %H:%M')
    return render(request, 'SalidaProducto/form.html',{'grupos': grupos, 'ServiciosWeb': ServiciosWeb, 
...
def FormularioOperadoresSalidaProductos(request, ID):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, "SalidaProducto/agregar.html",{'grupos': grupos, 'ServiciosWeb': ServiciosWeb, 
    'usuarioOperador':usuarioOperador, 'tblOperador': tblOperador})
...
def FormularioMovimientoAnimales(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'MovimientoAnimales/form.html',{'grupos': grupos, 'ServiciosWeb': ServiciosWeb,  
...
def FormularioSolicitudServido(request):
    ...
    ServiciosWeb = servicioActivo()
    return render(request, 'SolicitudServido/form.html',{'grupos': grupos, 'ServiciosWeb': ServiciosWeb,  'FECorrales': FECorrales, 'ultimo_folio':ultimo_folio,
